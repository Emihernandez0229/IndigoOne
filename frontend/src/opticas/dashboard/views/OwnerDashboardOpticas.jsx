...
import DashboardFilters from "../components/DashboardFiltersOpticas";
import LaboratoryQueue from "../components/LaboratoryQueue";


export default function OwnerDashboardOpticas() {

  const { data, loading, error } = useOpticasDashboard();
    ...
    >
      ...
      <div className="space-y-6">
        ...
        <DashboardGrid>
          ...
          <Can permission="optica.reports.view">
