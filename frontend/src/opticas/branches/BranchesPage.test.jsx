...
describe("BranchesPage", () => {
  ...
  it("el dueno Opticas ve las sucursales y el boton de nueva sucursal", async () => {
    authState.user = {
      role: ROLES.OPTICA_DUENO,
      permissions: getPermissionsForRole(ROLES.OPTICA_DUENO),
    };
  ...
  it("el gerente de sucursal no puede crear (no tiene el permiso)", async () => {
    authState.user = {
      role: ROLES.OPTICA_GERENTE_SUCURSAL,
      permissions: getPermissionsForRole(ROLES.OPTICA_GERENTE_SUCURSAL),
    };
